...
// Obtener lista de repartidores disponibles (aquellos que no tienen un vehículo asignado)
$repartidor_query = "
...
// Obtener lista de vehículos disponibles (vehículos sin un usuario asignado)
$vehiculo_query = "SELECT id, modelo FROM vehiculos WHERE id_usuario_asignado IS NULL";  // Vehículos sin usuario asignado
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id_repartidor && $id_vehiculo) {
        ...
        if ($mysqli->query($update_query)) {
            // Asignar el usuario al vehículo actualizando el campo id_usuario_asignado
